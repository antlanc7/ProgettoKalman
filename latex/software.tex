...
All'interno del costruttore viene chiamato il costruttore della superclasse (\textin{sistema}) al fine di inizializzare le variabili relative ad esse nell'oggetto \textit{kalmanfilter} :
\begin{lstlisting}[frame=single]
